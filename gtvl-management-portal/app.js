            ...
            const initialiseFeedback = () => {
              ...
              script.onload = async function () {
                new window.TiramaiFeedbackLib({
                  // Required
                  apiKey: "eyJidXNpbmVzc0lkZWFJZCI6IjgxNjcxMmJkLTgyNmItNDUzZS05YTU5LWQzMWFkY2I1N2NjOSIsImNyZWF0ZWRBdCI6MTc2Mzk4ODczODQxMiwiY3JlYXRlZEJ5IjoiY29kZWdlbmVzaXMifQ==",

                  // Context
                  businessIdeaId: "816712bd-826b-453e-9a59-d31adcb57cc9",
                  projectName: "gtvl-management-portal",
...
const initialiseRefiner = () => {
  ...
  script.onload = function () {
    ...
    new window.RefinerLib({
      ...
      personaRole: "Management",
      appTitle: "gtvl-management-portal",
      appType: "business",
      businessIdeaId: "816712bd-826b-453e-9a59-d31adcb57cc9",
      environment: "development",
    });
