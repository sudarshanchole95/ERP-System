            ...
            const initialiseFeedback = () => {
              ...
              script.onload = async function () {
                new window.TiramaiFeedbackLib({
                  // Required
                  apiKey: "eyJidXNpbmVzc0lkZWFJZCI6IjgxNjcxMmJkLTgyNmItNDUzZS05YTU5LWQzMWFkY2I1N2NjOSIsImNyZWF0ZWRBdCI6MTc2Mzk4ODc0MjAyNSwiY3JlYXRlZEJ5IjoiY29kZWdlbmVzaXMifQ==",

                  // Context
                  businessIdeaId: "816712bd-826b-453e-9a59-d31adcb57cc9",
                  projectName: "gtvl-supervisor-portal",
            ...
            const initialiseHelpbot = () => {              
              ...
              script.onload = function () {
                    new window.TiramaiHelpBotLib({
                      ...
                      apiKey: "eyJidXNpbmVzc0lkZWFJZCI6IjgxNjcxMmJkLTgyNmItNDUzZS05YTU5LWQzMWFkY2I1N2NjOSIsImNyZWF0ZWRBdCI6MTc2Mzk4ODc0MjAyNiwiY3JlYXRlZEJ5IjoiY29kZWdlbmVzaXMifQ==",
...
const initialiseRefiner = () => {
  ...
  script.onload = function () {
    ...
    new window.RefinerLib({
      ...
      personaRole: "Supervisor",
      appTitle: "gtvl-supervisor-portal",
      appType: "business",
      businessIdeaId: "816712bd-826b-453e-9a59-d31adcb57cc9",
      environment: "development",
    });
