            ...
            const initialiseFeedback = () => {
              ...
              script.onload = async function () {
                new window.TiramaiFeedbackLib({
                  // Required
                  apiKey: "eyJidXNpbmVzc0lkZWFJZCI6IjgxNjcxMmJkLTgyNmItNDUzZS05YTU5LWQzMWFkY2I1N2NjOSIsImNyZWF0ZWRBdCI6MTc2Mzk4ODc0MTI3NywiY3JlYXRlZEJ5IjoiY29kZWdlbmVzaXMifQ==",

                  // Context
                  businessIdeaId: "816712bd-826b-453e-9a59-d31adcb57cc9",
                  projectName: "gtvl-promodizer-portal",
                  personaRole: "Promodizer",
                  email: "N/A",
            ...
            const initialiseHelpbot = () => {              
              ...
              script.onload = function () {
                    new window.TiramaiHelpBotLib({
                      ...
                      apiKey: "eyJidXNpbmVzc0lkZWFJZCI6IjgxNjcxMmJkLTgyNmItNDUzZS05YTU5LWQzMWFkY2I1N2NjOSIsImNyZWF0ZWRBdCI6MTc2Mzk4ODc0MTI4MSwiY3JlYXRlZEJ5IjoiY29kZWdlbmVzaXMifQ==",
...
const initialiseRefiner = () => {
  ...
  script.onload = function () {
    ...
    new window.RefinerLib({
      ...
      personaRole: "Promodizer",
      appTitle: "gtvl-promodizer-portal",
      appType: "business",
      businessIdeaId: "816712bd-826b-453e-9a59-d31adcb57cc9",
      environment: "development",
    });
